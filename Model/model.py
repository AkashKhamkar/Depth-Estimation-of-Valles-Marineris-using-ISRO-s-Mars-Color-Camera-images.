...
class pix2pix(object):
    def __init__(self, sess, image_size=256,
                 ...
                 input_c_dim=3, output_c_dim=3, dataset_name='data o3too6',
    ...
    def load_random_samples(self):
        data = np.random.choice(glob('/content/drive/My Drive/{}/test/*.png'.format(self.dataset_name)), self.batch_size)
    ...
    def train(self, args):
        ...
        for epoch in xrange(args.epoch):
            data = glob('/content/drive/My Drive/{}/train/*.png'.format(self.dataset_name))
    ...
    def test(self, args):
        ...
        sample_files = glob('/content/drive/My Drive/{}/test/*.png'.format(self.dataset_name))
